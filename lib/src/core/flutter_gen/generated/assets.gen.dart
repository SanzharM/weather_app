...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/arrowLeftFilled.svg
  SvgGenImage get arrowLeftFilled =>
      const SvgGenImage('assets/icons/arrowLeftFilled.svg');

  /// File path: assets/icons/arrowRight.svg
  SvgGenImage get arrowRight =>
      const SvgGenImage('assets/icons/arrowRight.svg');

  /// File path: assets/icons/arrowRightFilled.svg
  SvgGenImage get arrowRightFilled =>
      const SvgGenImage('assets/icons/arrowRightFilled.svg');

  /// File path: assets/icons/arrowsDownUp.svg
  SvgGenImage get arrowsDownUp =>
      const SvgGenImage('assets/icons/arrowsDownUp.svg');

  /// File path: assets/icons/chevronLeft.svg
  SvgGenImage get chevronLeft =>
      const SvgGenImage('assets/icons/chevronLeft.svg');
